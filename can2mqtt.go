...
// SetExendedCanId activates/deactivates the extended can id usage.
// Default is false.
func SetExtendedCanId(v bool){
	extendedcanid = v
}
...
func Start() {
	...
	fmt.Println()
	wg.Add(1)
	go canStart(ci, extendedcanid) // epic parallel shit ;-)
	mqttStart(cs)
